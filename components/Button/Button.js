...
export default function Button({
  ...
  switch (type) {
    ...
    case 'bordered':
      ...
      break;
    case 'active':
      typeClass = `${styles.button} ${styles.buttonActive}`;
      break;
    case 'filter':
      typeClass = `${styles.button} ${styles.buttonFilter}`;
      break;
    case 'filter-selected':
      typeClass = `${styles.button} ${styles.buttonFilter} ${styles.buttonFilterSelected}`;
      break;
    case 'destruct':
