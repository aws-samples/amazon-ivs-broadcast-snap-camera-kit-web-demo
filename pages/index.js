...
import { FilterPaneButton, FiltersPane } from '../components/Filters';
...
export default function Broadcast() {
  ...
  const handleFilterPaneButton = () => {
    setFilterPaneOpen((prevState) => !prevState);
  };
      ...
      <div className={styles.broadcastWrapper}>
        ...
        <div className={styles.controlBar}>
          <div className={styles.controlBarLeft}>
            <FilterPaneButton
              active={filterPaneOpen}
              disabled={camMuted}
              handleFilterPaneButton={handleFilterPaneButton}
              filterPaneButtonText={
                filterPaneOpen
                  ? 'Hide filters'
                  : camMuted
                  ? 'Enable your camera to view filters'
                  : 'Show filters'
              }
            />
          </div>
